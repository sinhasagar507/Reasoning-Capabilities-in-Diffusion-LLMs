...
EVAL_SCRIPT="${REPO_ROOT}/eval/eval_sft_task2.py"
OUTROOT="${REPO_ROOT}/eval/results/eval_sweep_4datasets"

# ====== USER SETTINGS ======
BASE_MODEL="GSAI-ML/LLaDA-8B-Instruct"
SFT_CKPT="${REPO_ROOT}/eval/sft_checkpoints/llada_mix_temp07/checkpoint-942"  # PUT REAL STEP!
